      ...
      <div>
        <div className="flex flex-col md:flex-row md:items-start">
          ...
          <div className="flex-1 md:ml-20">
            ...
            <h3 className="md:ml-10">Sabrín hosts alternative comedy shows at his house and has near future plans of beginning an alternative comedy show in their Miami hometown.</h3>
          </div>
